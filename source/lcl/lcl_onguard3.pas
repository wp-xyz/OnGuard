...
function TLCLKeyMaintFrm.GetListBoxItemIndex : integer;                 {!!.07}
begin                                                                {!!.07}
...
procedure TLCLKeyMaintFrm.FormCreate(Sender: TObject);
begin
  InfoChanged(Sender);
end;

procedure TLCLKeyMaintFrm.InfoChanged(Sender: TObject);
var
  I       : Integer;
  IniFile : TIniFile;
begin
...
procedure TLCLKeyMaintFrm.AddBtnClick(Sender: TObject);
var
  F       : TLCLEditProductFrm;
  IniFile : TIniFile;
begin
  F := TLCLEditProductFrm.Create(Self);
  try
    F.SetKey(FKey);
    F.KeyType := FKeyType;
    F.ShowHint := ShowHint;
...
procedure TLCLKeyMaintFrm.EditBtnClick(Sender: TObject);
var
  F       : TLCLEditProductFrm;
  IniFile : TIniFile;
begin
...
procedure TLCLKeyMaintFrm.DeleteBtnClick(Sender: TObject);
var
  IniFile : TIniFile;
  I       : Integer;
  {$IFDEF Win16}
...
procedure TLCLKeyMaintFrm.KeyCopySbClick(Sender: TObject);
var
  OldSelStart: Integer;
begin
...
procedure TLCLKeyMaintFrm.CopyByteKeySbClick(Sender: TObject);
var
  OldSelStart: Integer;
begin
...
procedure TLCLKeyMaintFrm.OpenFileSbClick(Sender: TObject);begin
...
function TLCLKeyMaintFrm.GetKeyFileName : string;
begin
  Result := FileNameEd.Text;
end;

procedure TLCLKeyMaintFrm.SetKeyFileName(Value : string);
begin
  FileNameEd.Text := Value;
  InfoChanged(Self);
end;

procedure TLCLKeyMaintFrm.OpenBtnClick(Sender: TObject);
begin
  OpenDialog1.FileName := FileNameEd.Text;
  FileNameEd.Text := OpenDialog1.FileName;
  InfoChanged(Sender);
...
procedure TLCLKeyMaintFrm.ProductsLbDblClick(Sender: TObject);
begin
  ModalResult := mrOK;
end;

procedure TLCLKeyMaintFrm.KeyPasteSbClick(Sender: TObject);
begin
...
procedure TLCLKeyMaintFrm.SpeedButton1Click(Sender: TObject);
begin
...
procedure TLCLKeyMaintFrm.GetKey(var Value : TKey);                     {!!.08}
begin
  Value := FKey;
end;

procedure TLCLKeyMaintFrm.SetKey(Value : TKey);                         {!!.08}
begin
  FKey := Value;
end;
