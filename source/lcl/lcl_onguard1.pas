...
type
  TLCLKeyGenerateFrm = class(TForm)
    Panel1: TPanel;
    Label2: TLabel;
...
procedure TLCLKeyGenerateFrm.FormCreate(Sender: TObject);
begin
...
procedure TLCLKeyGenerateFrm.KeyStringMeChange(Sender: TObject);
begin
  BlockKeyEd.Text := '';
  ByteKeyEd.Text := '';
...
procedure TLCLKeyGenerateFrm.KeyTypeCbChange(Sender: TObject);
begin
  BlockKeyEd.Text := '';
  ByteKeyEd.Text := '';
...
procedure TLCLKeyGenerateFrm.BlockKeyEdChange(Sender: TObject);
begin
  CopyBlockSb.Enabled := (BlockKeyEd.Text <> '');
end;

procedure TLCLKeyGenerateFrm.CopyBlockSbClick(Sender: TObject);
var
  OldSelStart: Integer;
begin
...
procedure TLCLKeyGenerateFrm.ByteKeyEdChange(Sender: TObject);
begin
  CopyByteKeySb.Enabled := (ByteKeyEd.Text <> '');
end;

procedure TLCLKeyGenerateFrm.CopyByteKeySbClick(Sender: TObject);
var
  OldSelStart: Integer;
begin
...
procedure TLCLKeyGenerateFrm.GenerateBtnClick(Sender: TObject);
begin
...
procedure TLCLKeyGenerateFrm.SetKeyType(Value : TKeyType);
begin
...
procedure TLCLKeyGenerateFrm.GetKey(var Value : TKey);
begin
  Value := FKey;
end;

procedure TLCLKeyGenerateFrm.SetKey(Value : TKey);
begin
  FKey := Value;
end;


procedure TLCLKeyGenerateFrm.FormShow(Sender: TObject);
begin
