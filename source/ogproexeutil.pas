...
(*
   2015-Mar-10:
   These types, functions, and procedures were moved from ogproexe.pas
...
{$ENDIF}
{$IFDEF Win16}
function FileCRC32(const FileName : string) : ogLongInt;
{$ENDIF}
{$ELSE}
function FileCRC32(const FileName : string) : DWord;                     {!!.BB}
{$ENDIF}
procedure UpdateCRC32(var CRC : DWord;  const Buf;  BufSize : ogLongInt);  {!!.07}
...
procedure UpdateChecksum(var Sum : ogLongInt;  const Buf;  BufSize : ogLongInt);
var
